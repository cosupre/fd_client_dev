...
class InventoriesApi {
  ...
  ///
  /// 
  Future<Response<ResponseInventoryProductDto>> inventoriesControllerAddProduct({ 
  ...
  ///
  /// 
  Future<Response<BuiltList<ResponseInventoryProductDto>>> inventoriesControllerGetInventory({ 
    required String groupId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
