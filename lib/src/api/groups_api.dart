...
class GroupsApi {
  ...
  ///
  /// 
  Future<Response<ResponseGroupDto>> groupsControllerChangeGroupOwner({ 
    required String groupId,
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  ///
  /// 
  Future<Response<ResponseGroupDto>> groupsControllerChangeGroupSharingCode({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<ResponseGroupDto>> groupsControllerJoin({ 
    ...
    final _path = r'/groups/join/{sharing_code}'.replaceAll('{' r'sharing_code' '}', sharingCode.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// 
  Future<Response<void>> groupsControllerRemoveGroupMember({ 
    required String groupId,
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/groups/{groupId}/members/{userId}'.replaceAll('{' r'groupId' '}', groupId.toString()).replaceAll('{' r'userId' '}', userId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// 
  Future<Response<ResponseGroupDto>> groupsControllerUpdateGroupMember({ 
    required String groupId,
    required String userId,
    required UpdateGroupMemberDto updateGroupMemberDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateGroupMemberDto);
      _bodyData = _serializers.serialize(updateGroupMemberDto, specifiedType: _type);
